...
public class GameList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t = (TextView)findViewById(R.id.currentUser);
        //If user is not logged in, nothing will appear
        if(username.length() > 0){
            t.setText("Logged in as: " + username);
        }else{
            t.setText("");
        }
        //pauses the media player from playing background noise
    ...
    public void gotomath(View view){
        this.finish();
        Intent intent = new Intent(this, MathGames.class);
        startActivity(intent);
    }
    public void gotologic(View view){
        this.finish();
    ...
    public void PictureWordAssociation(View view){
        this.finish();
        Intent intent = new Intent(this, PictureWord.class);
        startActivity(intent);
    }
    ...
    public void createSpinnerControl()
    {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View selectedItemView, int position, long id) {
                //preferences set up
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(GameList.this);
                SharedPreferences.Editor editor = preferences.edit();
                //Get selected Item
