...
public class AccountCreation extends Activity {
    ...
    public void signup(View view){
        EditText fname = (EditText)findViewById(R.id.newAccountFirstName);
        EditText lname = (EditText)findViewById(R.id.newAccountLastName);
        EditText uname = (EditText)findViewById(R.id.newAccountUsername);
        EditText pass = (EditText)findViewById(R.id.newAccountPassword);
        EditText mail = (EditText)findViewById(R.id.newAccountEmail);
        ...
        createaccount.execute(firstname,lastname,username,password,email);
    }
    ...
    public void createSpinnerControl()
    {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View selectedItemView, int position, long id) {
                //preferences set up
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(AccountCreation.this);
                SharedPreferences.Editor editor = preferences.edit();
                //Get selected Item
