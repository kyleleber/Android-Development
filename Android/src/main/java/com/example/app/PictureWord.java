...
public class PictureWord extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.picture_word, menu);
        return true;
    }
    ...
    public void startAnimalActivity(View view){
        ...
        editor.putString("gameid","0");
        editor.commit();
        Intent intent = new Intent(this, AnimalAssociation.class);
    ...
    public void startColorActivity(View view){
        ...
        editor.commit();
        Intent intent = new Intent(this, ColorAssociation.class);
        intent.putExtra("gameid", "1");
        startActivity(intent);
    }
    public void startAnimalWordActivity(View view){
        music.releaseMusic();
        this.finish();
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
        SharedPreferences.Editor editor = preferences.edit();
        ...
        editor.commit();
        Intent intent = new Intent(this, AnimalWordAssociation.class);
    ...
    public void createSpinnerControl()
    {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View selectedItemView, int position, long id) {
                //preferences set up
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(PictureWord.this);
                SharedPreferences.Editor editor = preferences.edit();
                //Get selected Item
