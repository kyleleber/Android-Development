...
public class MathGames extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.math_games, menu);
        return true;
    }
    ...
    //Add subtract
    public void startAddSubtract(View view){
        music.releaseMusic();
        this.finish();
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString("gameid","3");
        editor.commit();
    ...
    //MultiplyDevide
    public void startMultiplyDevide(View view){
        music.releaseMusic();
        this.finish();
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString("gameid","4");
        editor.commit();
        Intent intent = new Intent(this, Mathematics.class);
    ...
    //Order of ops
    public void startOrderOfOps(View view){
        music.releaseMusic();
        this.finish();
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString("gameid","5");
        editor.commit();
        Intent intent = new Intent(this, Mathematics.class);
    ...
    public void createSpinnerControl()
    {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View selectedItemView, int position, long id) {
                //preferences set up
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(MathGames.this);
                SharedPreferences.Editor editor = preferences.edit();
                //Get selected Item
